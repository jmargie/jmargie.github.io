...
<nav class="side-menu">
  ...
  <ul>
    <li><a href="#quotes">Quotes / Motivation</a></li>
    <li><a href="#planning">Planning</a></li>
    <li><a href="#methods">Methods</a></li>
    <li><a href="#results">Results</a></li>
    <li><a href="#heatmaps">Heatmaps</a></li>
    <li><a href="#did-effects">DiD Effects</a></li>
...
## Bar Graph Comparisons {#bargraph}
...
## More Summary Tables for Exact Numbers (Calculated from Different Models) {#moresum}
